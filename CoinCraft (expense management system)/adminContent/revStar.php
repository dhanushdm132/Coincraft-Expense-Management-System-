    ...
    <main class="d-flex flex-nowrap">
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="revStar.php" class="nav-link active">
                        <svg class="bi pe-none me-2" width="16" height="16">
                            <use xlink:href="#grid" />
                        </svg>
                        Rev Stars
        ...
        <div class="overflow-auto w-100">
            <?php
            include 'mainContent/revStar.php';
        ?>
        </div>
    </main><script src="https://code.jquery.com/jquery-3.7.0.js"></script>
    ...
    <script>
        ...
        Array.from(edits).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                ASN = tr.getElementsByTagName("td")[0].innerText;
                ASD = tr.getElementsByTagName("td")[1].innerText;
        ...
        Array.from(deletes).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                if (confirm("Are you sure you want to delete this note!")) {
                    ...
                    window.location = `/coincraft/adminContent/revStar.php?delete=${sno}`;
