    ...
    <script>
        ...
        Array.from(edits).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                AUFN = tr.getElementsByTagName("td")[0].innerText;
                AULN = tr.getElementsByTagName("td")[1].innerText;
        ...
        Array.from(deletes).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                if (confirm("Are you sure you want to delete this User!")) {
                    ...
                    window.location = `/coincraft/adminContent/users.php?delete=${sno}`;
