...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    //   $result = mysqli_query($conn, $sql);
      // Sql query to be executed
      $sql = "UPDATE `message` SET `name` = '$AMNE', `description` = '$AMDE' WHERE `id` = '$sno'";
      $result = mysqli_query($conn, $sql);
      if($result){
      ...
      // Sql query to be executed
      $sql = "INSERT INTO `message` ( `name`, `description`) VALUES ( '$AMN', '$AMD')";
      $result = mysqli_query($conn, $sql);
...
?>
                            ...
                            <div class="col-md-6">
                                <div class="input-group  ">
                                    ...
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="AMNE" placeholder="Username"
                                            name="AMNE">
                                        <label for="AMNE">Message name</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row g-2  mb-3 ">
                            <div class="col-md-10">
                                <div class="input-group  ">
                                    ...
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="AMDE" placeholder="Username"
                                            name="AMDE">
                                        <label for="AMDE">Description</label>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="col-md-6">
    ...
    <div class="container p-4 my-0  ">
        <div class="card text-center w-75 mx-auto">
            <div class="card-body">
                <h5 class="card-title">Message Count :
                    <?php
                $sql = 'SELECT COUNT(*) AS total_message FROM message';
                $result = mysqli_query($conn, $sql);
                $sno = 0;
                while($row = mysqli_fetch_assoc($result)){
                   echo $row['total_message'];
                } 
                ?>
                </h5>
            </div>
                            ...
                            <div class="row g-2  mb-3 ">
                                <div class="col-md-6">
                                    <div class="input-group  ">
                                        <span class="input-group-text">Message Name</span>
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="AMN" placeholder="Username"
                                                name="AMN">
                                            <label for="AMN">Message Name</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row g-2  mb-3 ">
                                <div class="col-md-10">
                                    <div class="input-group  ">
                                        <span class="input-group-text">Description</span>
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="AMD" placeholder="Username"
                                                name="AMD">
                                            <label for="AMD">Description</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
