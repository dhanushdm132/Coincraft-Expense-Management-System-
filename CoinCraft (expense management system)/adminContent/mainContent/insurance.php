...
if(isset($_GET['delete'])){
    $sno = $_GET['delete'];
    $delete = true;
    $sql = "DELETE FROM `_insurance` WHERE `id` = $sno";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    //   $result = mysqli_query($conn, $sql);
      // Sql query to be executed
      $sql = "UPDATE `_insurance` SET `name` = '$AINE', `description` = '$AIDE' WHERE `id` = '$sno'";
      $result = mysqli_query($conn, $sql);
      if($result){
        echo '<div class="alert alert-success alert-dismissible fade show m-4" role="alert">
          <strong>Success!</strong> Insurance Type Updated successfully.
      ...
      // Sql query to be executed
      $sql = "INSERT INTO `_insurance` ( `name`, `description`) VALUES ( '$AIN', '$AID')";
      $result = mysqli_query($conn, $sql);
    
       
      if($result){ 
          echo '<div class="alert alert-success alert-dismissible fade show m-4" role="alert">
          <strong>Success!</strong> Insurance Type added successfully.
          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>';
      }
      else{
...
?>
                        ...
                        <div class="row g-2  mb-3 ">
                            <div class="col-md-6">
                                <div class="input-group  ">
                                    <span class="input-group-text">Insurance Name</span>
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="AINE" placeholder="Username"
                                            name="AINE">
                                        <label for="AINE">Insurance name</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row g-2  mb-3 ">
                            <div class="col-md-10">
                                <div class="input-group  ">
                                    ...
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="AIDE" placeholder="Username"
                                            name="AIDE">
                                        <label for="AIDE">Description</label>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="col-md-6">
    ...
    <div class="container p-4 my-0  ">
        <div class="card text-center w-75 mx-auto">
            <div class="card-body">
                <h5 class="card-title">Insurance Count :
                    <?php
                $sql = 'SELECT COUNT(*) AS total_insurance FROM _insurance';
                $result = mysqli_query($conn, $sql);
                $sno = 0;
                while($row = mysqli_fetch_assoc($result)){
                   echo $row['total_insurance'];
                } 
                ?>
                </h5>
            </div>
                ...
                <div class="card card-body">
                    <div class="container px-5 pt-3  ">
                        ...
                        <form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="POST">
                                    ...
                                    <div class="input-group  ">
                                        ...
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="amount" placeholder="Username"
                                                name="AIN">
                                            <label for="amount">Insurance Name</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary">Add Insurance type</button>
                            <button type="reset" class="btn btn-outline-primary ml-3">Clear</button>
                        </form>
                    </div>
                </div>
