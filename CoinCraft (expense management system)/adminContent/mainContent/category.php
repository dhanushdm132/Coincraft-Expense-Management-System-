...
if(isset($_GET['delete'])){
    $sno = $_GET['delete'];
    $delete = true;
    $sql = "DELETE FROM `_category` WHERE `id` = $sno";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    //   $result = mysqli_query($conn, $sql);
      // Sql query to be executed
      $sql = "UPDATE `_category` SET `name` = '$ACNE', `description` = '$ACDE' WHERE `id` = '$sno'";
      $result = mysqli_query($conn, $sql);
      if($result){
      ...
      // Sql query to be executed
      $sql = "INSERT INTO `_category` ( `name`, `description`) VALUES ( '$ACN', '$ACD')";
      $result = mysqli_query($conn, $sql);
...
?>
                            ...
                            <div class="col-md-6">
                                <div class="input-group  ">
                                    ...
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="ACNE" placeholder="Username"
                                            name="ACNE">
                                        <label for="ACNE">Category name</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row g-2  mb-3 ">
                            <div class="col-md-10">
                                <div class="input-group  ">
                                    ...
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="ACDE" placeholder="Username"
                                            name="ACDE">
                                        <label for="ACDE">Description</label>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="col-md-6">
    ...
    <div class="container p-4 my-0  ">
        <div class="card text-center w-75 mx-auto">
            <div class="card-body">
                <h5 class="card-title">Category Count :
                    <?php
                $sql = 'SELECT COUNT(*) AS total_category FROM _category';
                $result = mysqli_query($conn, $sql);
                $sno = 0;
